export default class PubSub {
    ...
    subscribe(event, callback) {
        ...
        const subSub=self.events[event].push(callback)
        // console.log('New Subscribe: ',subSub, self.events);
        return subSub;
    }
    ...
    publish(event, data = {}) {
        ...
        const subPublish=self.events[event].map(callback => callback(data))
        console.log('New Publish : ', subPublish, self.events);
        return subPublish;
    }
}